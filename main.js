const apiKey = "eaa149bfe5ba87940f641f4211c3b55d";
...
async function checkWeather(city){
    ...
    if(response.status == 404){
        ...
        else if (data.weather[0].main == "Clear") weatherIcon.src = "images/rain.png";
        else if (data.weather[0].main == "Rain") weatherIcon.src = "images/clouds.png";
